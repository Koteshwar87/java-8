package practice.multithreading.synchronization.producerconsumer.multipleproducerconsumer.scaler.semaphore;
...
/***
 * Usage of Semaphore.
 * Allows more than 1 thread to be present inside Critical Section.
 */
public class Main {
